...
const ASSETS = [
    ...
    './js/debate-scenarios.js',
    './js/engine.js',
  './js/campaign-finance.js',
  './js/game-commands.js',
  './js/opponent-campaign.js',
    './js/save-store.js',
    './js/career-system.js',
  ...
  './js/people.js',
    './js/interviews.js',
    './js/world.js',
    './js/world-geometry.js',
    './js/geography.js',
    './js/war.js',
    './js/presidency.js',
    './js/simulation.js',
    './js/election-system.js',
  './js/narrative-director.js',
  './js/debate-round.js',
    './js/ui.js',
